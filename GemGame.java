...
public class GemGame 
{
	...
	public static void main(String [] args)
	{
		...
		//getting user input for both players' names
        ...
        GemList player1 = new GemList(player1Name);
        GemList player2 = new GemList(player2Name);
       ...
       if (score1 == score2)
       	...
       	StdDraw.text(0.5, SCORE_Y, player1Name + " wins by " + (score1 - score2) + " points!");
       else 
       	StdDraw.text(0.5, SCORE_Y, player2Name+ " wins by " + (score2 - score1) + " points!");
